...
## Characters and story archive

The **Characters** tab keeps the whole core cast in one place. Open a
character to see their species, combat role, element, Bond, ascension status,
and seven-beat story route. Completed scenes can be replayed from the profile;
